        ...
        <div className="absolute w-full h-full flex">
          <div key={currentItem.id} className="container mx-auto ">
            ...
            <div className="w-full px-8 py-3 flex justify-between items-center">
              <div className='w-4/6 lg:w-3/6 flex justify-around items-center'>
              ...
              <div className="w-2/6 md:w-1/6 flex justify-evenly items-center">
                <div>
            ...
            <div className="w-full h-[600px] flex flex-col-reverse lg:flex-row justify-between items-center">
              ...
              <div className='w-full lg:w-2/6 h-[400px] px-4 lg:pl-10 mt-2 lg:mt-0'>
                ...
                <div className='relative w-5/6 flex justify-start items-center'>
                  ...
                  <h1 className="text-[4rem] text-[#313030] leading-10 tracking-wide md:tracking-widest ml-6">{currentItem.title}</h1>
                </div>
